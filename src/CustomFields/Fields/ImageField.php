			...
			<td>
				...
				<div class="image-uploader">
					...
					<div class="image-uploader__buttons">
						<button class="image-uploader__button image-uploader__button--choose<?php echo false === $img_src ? '' : ' hide-image-uploader'; ?>"><?php _e('Choose image', 'heikkivihersalo-custom-post-types'); ?></button>
						<button class="image-uploader__button image-uploader__button--remove<?php echo false === $img_src ? ' hide-image-uploader' : ''; ?>"><?php _e('Remove Image', 'heikkivihersalo-custom-post-types'); ?></button>
					</div>
				</div>
			</td>
		</tr>
